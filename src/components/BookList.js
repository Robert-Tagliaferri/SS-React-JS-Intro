...
export class BookList extends React.Component {
    ...
    createBookRow(book) {
        return (
            <tr key={book.id}>
                <td>
                    <button className="btn btn-secondary update" onClick={() => this.handleUpdate(book)}>Update</button>
                    <button className="btn btn-danger delete" onClick={() => this.handleDelete(book)}>Delete</button>
                </td>
                <td> {book.book_id} </td>
                <td> {book.title} </td>
                <td> {book.author} </td>
